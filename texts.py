# СЕРЬЁЗНЫЙ ТЕСТ DiSC (18 вопросов)
# Форматы:
# - slider: поля text, left, right, cat_l, cat_r
# - mc: поля text, options (список кортежей (текст, категория))
# - assoc: поля text, icons, cats (длины строго равны)
DISC_QUESTIONS = [
    # Q1 — Slider
    {
        "type": "slider",
